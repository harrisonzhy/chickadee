...
struct generic_file {
    ...
    static constexpr unsigned namesize = 64UL;
};
...
struct memfile {
    ...
    static constexpr unsigned argvsize = 64;
...
inline memfile::memfile()
    : name_(""), data_(nullptr), len_(0), capacity_(0), v_(nullptr) {
}
